$(document).ready(function () {
    ...
    if (1 === $(".material-design-hamburger__icon").length && document.querySelector(".material-design-hamburger__icon").addEventListener("click", function () {
        ...
        $(".fixed-sidebar .navigation-toggle a").removeClass("sidenav "),
    ...
    $(".sidebar-account-settings:not(.show)").fadeOut(0),
        ...
        $(".sidenav :not(.right-sidebar-button)").sidenav(),
        $(".sidenav .right-sidebar-button").sidenav({
            edge: "right"
        }),
        $(".chat-button").sidenav({
            edge: "right"
        ...
        $(".left-sidebar-hover").mouseover(function () {
            $(".sidenav ").click(),
                ...
                $("#slide-out").mouseleave(function () {
                    $(this).hasClass("openOnHover") && ($(".sidenav ").click(),
